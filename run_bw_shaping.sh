...
: ${sim_method:="fix_ma"}
: ${siminet_path:="${dataset_root}/datasets/${dataset}/model_ckpt/siminet/${local_model}/sample_duration_${window_size}/image_size_${local_image_size}/bce_loss/save_99.pth"}
: ${filter_interval:=6}
